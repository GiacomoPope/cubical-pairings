...
def gen_data(params):
    ...
    print("// <P, Q> are the generators of the curve of order N = 2^ea")
    point_to_rust(P, "P")
    point_to_rust(Q, "Q")
    print("// P - Q")
    ...
    tate_exp2 = P.tate_pairing(Q, A, k=2)
    weil_exp2 = P.weil_pairing(Q, A)

    print("// Tate pairings for order: e_2^ea(P, Q)")
    field_to_rust(tate_exp2, "tate_pairing")
    print()

    print("// Weil pairings for order: e_2^ea(P, Q)")
    field_to_rust(weil_exp2, "weil_pairing")
    print()
