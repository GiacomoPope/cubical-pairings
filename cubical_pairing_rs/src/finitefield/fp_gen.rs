...
macro_rules! define_fp_tests {
    ($with_sum_and_diff_of_products: literal) => {
        use super::Fp;
        ...
        fn check_fp_ops(
            ...
            vb: &[u8],
            with_sqrt: bool,
            with_sum_and_diff_of_products: bool,
        ) {
            ...
            if with_sum_and_diff_of_products {
        ...
        fn fp_ops() {
            ...
            for i in 0..300 {
                ...
                check_fp_ops(&va, &vb, i < 30, $with_sum_and_diff_of_products);
            }
        }
    };
